...
module.exports = function(ClientModel) {
     ...
     * @param {Boolean} [restrictOrigin=false]
     * @param {Boolean} [restrictRedirect=false]
    ...
    return function(options) {
        ...
        return function(req, res) {
            ...
            if( opt.restrictScope ) {
                ...
                if (!routeUID) {
                    let err = new ServiceError('Expected route`s uid, got ' + typeof routeUID);
            ...
            return ClientModel.findById(clientId).then(function(client) {
                ...
                let clientScopes = client.scopes || [];
