...
const Response            = require('../express/response.js');//TODO
...
Route.prototype.acceptsContentType = function(type, options, parser) {
    ...
    if (this.$dataParserMiddleware === null) {
        this.$dataParserMiddleware = {
            ...
            fn: function() {
                return this.$getContentTypeParser.apply(this, arguments);
            },
            contentTypes: {},
            mediaTypes: []
        };
...
function pushErrorHandler() {
    ...
    this.catch(function(err, req, res) {
        return app.emitAsyncSeries(
            'error-response',
            errorHandler.errorHandler(err, app, {
                req.UID,
                route.uid
            });
        );
