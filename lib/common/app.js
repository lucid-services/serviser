 ...
 * (aka. doesn't happen outside of the application scope), the Error is coerced
 ...
 * Errors with the [bi-logger](https://github.com/BohemiaInteractive/bi-logger) package.  
