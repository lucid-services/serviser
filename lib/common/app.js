...
App.prototype.getValidator = function getValidator() {
    if (this.validator === null) {
        ...
        //custom ajv keywords provided by serviser
...
/**
 * emitted before internal initialization of the App instance which will
 * validate configuration, setup default application wide response headers and
 ...
 * {@link AppInterface#event:pre-build} and {@link AppInterface#event:post-build} events.  
 ...
 * Errors with the [serviser-logger](https://github.com/lucid-services/serviser-logger) package.  
