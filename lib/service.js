...
/**
 * all registered apps are successfully initialized and at this point usually already can receive connections
 * @event Service#listening
 * @type {undefined}
 */

/**
 * listeners are expected to registed all Apps with Router & Route definitions.
...
/**
 * this event allows to hook-up `bi-service` plugins
 * @example
 * const Service = require('bi-service');
 *
...
Service.onPostInit = function onPostInit(app) {
    process.nextTick(function() {
        ...
        //TODO delegate the responsibility of building an app to the app itself
