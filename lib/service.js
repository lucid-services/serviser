    ...
    return new Promise(function(resolve, reject) {
        ...
        function tick() {
            ...
            return self.$setup().then(function() {
                 ...
                 * successfully initialized before a $setup Error gets propagated
            ...
            function onServiceError(err) {
                ...
                logger.error(err, function() {
                    //TODO process abortion should be preferably handled by
...
Service.onListening = function onListening(app) {
    ...
    console.log(`${app.name} app listening on port: ${port}`);
};
