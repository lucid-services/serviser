...
var Command = {
    ...
    build: function(cli) {
        ...
        .option('-s, --sort', "Defines sort order. Can contain characters m|u|i which corresponds to (m)ethod, (u)rl, u(i)d columns")
     ...
     * @param {String}        [options.sort] - Defines sort order. Can contain characters m|u|i which corresponds to (m)ethod, (u)rl, u(i)d
     *
     * @return {String}
     */
