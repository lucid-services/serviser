...
ResourceManager.prototype.inspectIntegrity = Promise.method(function(tag, options) {
    ...
    heap = _.reduce(resources, function(out, resource, name) {
        //wraps inspectIntegrity promise into a explicit bluebird instance
        //as resource can return non-bluebird promise instance
        //TODO unit test this
        out[name] = Promise.resolve(resource.inspectIntegrity()).reflect();
        return out;
    }, {});
