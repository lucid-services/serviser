 ...
 * @return {Object}
 */
module.exports.loadSync = function(paths){
    loadFnOptionsCache = Array.prototype.slice.call(arguments, 0);

    var args = getCommandArgs(paths);
    ...
    if (result.status !== 0) {
        ...
        err.stderr = typeof result.stderr !== 'string' ? result.stderr.toString(): result.stderr;
        err.stdout = typeof result.stdout !== 'string' ? result.stdout.toString(): result.stdout;
        throw err;
    }
 ...
 */
module.exports.load = Promise.method(function(paths){
    loadFnOptionsCache = Array.prototype.slice.call(arguments, 0);
...
function getCommandArgs(paths) {
    ...
    return generate(paths.orm, 'orm-path')
        ...
        .concat(generate(paths.config, 'config'));
