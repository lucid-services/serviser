 ...
 * @param {String} options.description - swagger doc
 *
 * @constructor
 **/
function Route(options) {
    ...
    if (   _.isPlainObject(this.Router.App.models.odm)
        && this.Router.App.models.odm.hasOwnProperty('Client')
    ) {
...
Route.prototype.restrictByClient = function(options) {
    if (!this.hasOwnProperty('$clientMiddleware')) {
        throw new RouteError('The middleware not initialized. No `Client` model binding was found in time of the init procedure');
    }
 ...
 * schema definition or object which implements `toSwagger` getter method.
 *
...
Route.prototype.respondsWith = function(descriptor) {
    ...
    responses[code].schema = descriptor;
